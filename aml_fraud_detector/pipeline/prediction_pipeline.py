...
class CustomData:
    ...
    def _validate_and_transform(self, account, account_1,
                                amount_received, payment_format, day):
        try:
    ...
    def get_data_as_DataFrame(self):
        try:
            ...
            df["account_1"] = df["account_1"].astype("object")
            df["amount_received"] = df["amount_received"].astype("float64")
            df["payment_format"] = df["payment_format"].astype("object")
