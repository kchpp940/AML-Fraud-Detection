...
ERROR_CATEGORY_DISPLAY = {
    ErrorCategory.DATA_QUALITY: "数据质量问题",
    ErrorCategory.INPUT_VALIDATION: "输入验证失败",
    ErrorCategory.FEATURE_ALIGNMENT: "特征对齐错误",
    ErrorCategory.MODEL_LOADING: "模型加载失败",
    ErrorCategory.METADATA_VALIDATION: "元数据验证失败",
    ErrorCategory.PREDICTION_ERROR: "预测执行失败",
    ErrorCategory.EXPLANATION_ERROR: "解释生成失败",
    ErrorCategory.CONFIG_ERROR: "配置错误",
    ErrorCategory.PIPELINE_ERROR: "管道执行失败",
...
ERROR_SEVERITY = {
    ...
    ErrorCode.DATA_MISSING_COLUMNS: "high",
    ErrorCode.DATA_INVALID_DTYPE: "high",
    ErrorCode.DATA_OUT_OF_RANGE: "medium",
    ErrorCode.DATA_CORRUPTED: "critical",
    ErrorCode.DATA_SAMPLING_ERROR: "high",
    ErrorCode.INPUT_MISSING_FIELD: "high",
    ErrorCode.INPUT_INVALID_TYPE: "high",
    ErrorCode.INPUT_INVALID_FORMAT: "medium",
    ErrorCode.INPUT_OUT_OF_RANGE: "medium",
    ErrorCode.INPUT_EMPTY_VALUE: "medium",
    ErrorCode.FEATURE_MISMATCH: "critical",
    ErrorCode.FEATURE_MISSING: "critical",
    ErrorCode.FEATURE_UNEXPECTED: "warning",
    ErrorCode.FEATURE_TRANSFORM_FAILED: "critical",
    ErrorCode.FEATURE_ENCODING_FAILED: "critical",
    ...
    ErrorCode.METADATA_FILE_NOT_FOUND: "critical",
    ErrorCode.METADATA_CORRUPTED: "critical",
    ErrorCode.METADATA_SCHEMA_MISMATCH: "critical",
    ErrorCode.METADATA_VERSION_MISMATCH: "high",
    ErrorCode.MANIFEST_INTEGRITY_FAILED: "critical",
    ErrorCode.ARTIFACT_MISSING: "critical",
    ErrorCode.PREDICTION_FAILED: "high",
    ErrorCode.PREDICTION_SHAPE_MISMATCH: "high",
    ErrorCode.BATCH_PREDICTION_FAILED: "high",
    ErrorCode.EXPLANATION_NOT_SUPPORTED: "warning",
    ErrorCode.EXPLANATION_FAILED: "medium",
    ErrorCode.EXPLANATION_MODEL_INCOMPATIBLE: "warning",
    ErrorCode.CONFIG_FILE_NOT_FOUND: "critical",
    ErrorCode.CONFIG_PARSE_FAILED: "high",
    ErrorCode.CONFIG_INVALID_VALUE: "high",
    ErrorCode.CONFIG_MISSING_REQUIRED: "high",
    ErrorCode.PIPELINE_STEP_FAILED: "critical",
    ErrorCode.PIPELINE_INVALID_STATE: "critical",
    ErrorCode.PIPELINE_DEPENDENCY_MISSING: "critical",
