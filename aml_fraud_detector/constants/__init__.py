...
ERROR_CATEGORY_DISPLAY = {
    ErrorCategory.DATA_QUALITY: "数据质量错误",
    ErrorCategory.INPUT_VALIDATION: "输入校验错误",
    ErrorCategory.FEATURE_ALIGNMENT: "特征对齐错误",
    ErrorCategory.MODEL_LOADING: "模型加载错误",
    ErrorCategory.METADATA_VALIDATION: "元数据/产物校验错误",
    ErrorCategory.PREDICTION_ERROR: "预测执行错误",
    ErrorCategory.EXPLANATION_ERROR: "风险解释错误",
    ErrorCategory.CONFIG_ERROR: "配置错误",
    ErrorCategory.PIPELINE_ERROR: "管道执行错误",
    ErrorCategory.INTERNAL_ERROR: "系统内部错误",
}
...
ERROR_SEVERITY = {
    ...
    ErrorCode.DATA_SAMPLING_ERROR: "warning",
    ErrorCode.INPUT_MISSING_FIELD: "warning",
    ErrorCode.INPUT_INVALID_TYPE: "warning",
    ErrorCode.INPUT_INVALID_FORMAT: "warning",
    ErrorCode.INPUT_OUT_OF_RANGE: "warning",
    ErrorCode.INPUT_EMPTY_VALUE: "warning",
    ...
    ErrorCode.PREDICTION_FAILED: "critical",
    ErrorCode.PREDICTION_SHAPE_MISMATCH: "critical",
    ErrorCode.BATCH_PREDICTION_FAILED: "critical",
    ...
    ErrorCode.CONFIG_PARSE_FAILED: "critical",
    ErrorCode.CONFIG_INVALID_VALUE: "warning",
    ErrorCode.CONFIG_MISSING_REQUIRED: "critical",
